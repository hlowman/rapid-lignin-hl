...
masterer <- mastered[-181,] # Removes the crazy high outlier for d13C.
...
#tiff(filename = "/Users/heililowman/Documents/UC_Santa_Barbara/Research_Lignin/Figures/Manuscript_figure_files/Fig4.tiff", width=10, height=6, unit="in", res=400) 
fig4 <- ggplot(masterer, aes (x=d13C, y=Sigma8, shape=Environment, fill=Environment)) +
  geom_point(size=3,
             stroke = 0.75,
             alpha = 0.8) +
  scale_shape_manual(values = c(21, 24, 22)) +
...
fig5 <- ggplot(masterer, aes (x=d13C, y=Bd.V, shape=Environment, fill=Environment)) +
  geom_point(size=3,
             stroke = 0.75,
             alpha = 0.8) +
  scale_shape_manual(values = c(21, 24, 22)) +
