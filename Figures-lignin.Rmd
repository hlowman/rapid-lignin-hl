...
rainplot <- ggplot(rain, aes(DATE, Rainfall_cm)) +
  annotate("rect", fill = "gray88", alpha = 0.75, 
        xmin = mdy("12-01-2015"), xmax = mdy("12-31-2015"),
        ymin = 13, ymax = Inf) + # December 2015 - Marine sampling
  annotate("rect", fill = "gray88", alpha = 0.75, 
        xmin = mdy("06-01-2016"), xmax = mdy("06-30-2016"),
        ymin = 12.25, ymax = 13) + # June 2016 - Marine sampling
  annotate("rect", fill = "gray88", alpha = 0.75, 
        xmin = mdy("03-01-2017"), xmax = mdy("03-30-2017"),
        ymin = 12.25, ymax = 13) + # March 2017 - Marine sampling
  annotate("rect", fill = "gray88", alpha = 0.75, 
        xmin = mdy("06-01-2017"), xmax = mdy("06-30-2017"),
        ymin = 12.25, ymax = 13) + # June 2017 - Marine sampling
  annotate("rect", fill = "gray30", alpha = 0.75, 
        xmin = mdy("01-01-2016"), xmax = mdy("01-31-2016"),
        ymin = 13, ymax = Inf) + # Jan 2016 - Stream sampling
  annotate("rect", fill = "gray30", alpha = 0.75, 
        xmin = mdy("03-01-2016"), xmax = mdy("03-31-2016"),
        ymin = 13, ymax = Inf) + # March 2016 - Stream sampling
  annotate("rect", fill = "gray30", alpha = 0.75, 
        xmin = mdy("01-01-2017"), xmax = mdy("01-31-2017"),
        ymin = 13, ymax = Inf) + # Jan 2017 - Stream sampling
  annotate("rect", fill = "gray56", alpha = 0.75, 
        xmin = mdy("04-01-2016"), xmax = mdy("04-30-2016"),
        ymin = 13, ymax = Inf) + # April 2016 - Estuarine sampling
  annotate("rect", fill = "gray56", alpha = 0.75, 
        xmin = mdy("06-01-2016"), xmax = mdy("06-30-2016"),
        ymin = 13, ymax = Inf) + # June 2016 - Estuarine sampling
  annotate("rect", fill = "gray56", alpha = 0.75, 
        xmin = mdy("03-01-2017"), xmax = mdy("03-30-2017"),
        ymin = 13, ymax = Inf) + # March 2017 - EStuarine sampling
  annotate("rect", fill = "gray56", alpha = 0.75, 
        xmin = mdy("06-01-2017"), xmax = mdy("06-30-2017"),
        ymin = 13, ymax = Inf) + # June 2017 - EStuarine sampling
...
Fig3_Stats <- mastered %>% # Takes the original dataset and then ...
  ...
  mutate(Environment = factor(Environment, levels = c( "Stream", "Estuary", "Reef"))) %>% # Relevels.
