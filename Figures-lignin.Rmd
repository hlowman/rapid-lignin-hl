...
#tiff(filename = "/Users/heililowman/Documents/UC_Santa_Barbara/Research_Lignin/Figures/Manuscript_figure_files/Fig6_colora.tiff", width=8, height=6, unit="in", res=400) 
fig6_colora
#dev.off
...
#tiff(filename = "/Users/heililowman/Documents/UC_Santa_Barbara/Research_Lignin/Figures/Manuscript_figure_files/Fig6_colorb.tiff", width=8, height=6, unit="in", res=400) 
fig6_colorb
#dev.off
...
#tiff(filename = "/Users/heililowman/Documents/UC_Santa_Barbara/Research_Lignin/Figures/Manuscript_figure_files/Fig6_colorc.tiff", width=8, height=6, unit="in", res=400) 
fig6_colorc
#dev.off
...
fig7b_colora <- ggplot(m_cvsva, aes (x=meanC.V, y=meanS.V, color = Group)) +
  geom_point(size=8,
             stroke = 0.75) +
  scale_color_manual(values = c("#69B9FA"), labels = c("12/2015")) +
  xlim(0,0.25) +
  ylim(0,5.5) +
  theme_bw() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank()) +
...
#tiff(filename = "/Users/heililowman/Documents/UC_Santa_Barbara/Research_Lignin/Figures/Manuscript_figure_files/Fig7b_colora.tiff", width=8, height=6, unit="in", res=400) 
fig7b_colora
#dev.off
...
fig7b_colorb <- ggplot(m_cvsvb, aes (x=meanC.V, y=meanS.V, color = Group)) +
  geom_point(size=8,
             stroke = 0.75) +
  scale_color_manual(values = c("#69B9FA", "#59A3F8"), labels = c("12/2015", "06/2016")) +
  xlim(0,0.25) +
  ylim(0,5.5) +
  theme_bw() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank()) +
...
#tiff(filename = "/Users/heililowman/Documents/UC_Santa_Barbara/Research_Lignin/Figures/Manuscript_figure_files/Fig7b_colorb.tiff", width=8, height=6, unit="in", res=400) 
fig7b_colorb
#dev.off
...
fig7b_colorbb <- ggplot(m_cvsvbb, aes (x=meanC.V, y=meanS.V, color = Group)) +
  geom_point(size=8,
             stroke = 0.75) +
  scale_color_manual(values = c("#69B9FA", "#59A3F8", "#5A7ECB"), labels = c("12/2015", "06/2016", "03/2017")) +
  xlim(0,0.25) +
  ylim(0,5.5) +
  theme_bw() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank()) +
...
#tiff(filename = "/Users/heililowman/Documents/UC_Santa_Barbara/Research_Lignin/Figures/Manuscript_figure_files/Fig7b_colorbb.tiff", width=8, height=6, unit="in", res=400) 
fig7b_colorbb
#dev.off
...
#tiff(filename = "/Users/heililowman/Documents/UC_Santa_Barbara/Research_Lignin/Figures/Manuscript_figure_files/Fig7b_colorc.tiff", width=8, height=6, unit="in", res=400) 
fig7b_colorc
#dev.off
